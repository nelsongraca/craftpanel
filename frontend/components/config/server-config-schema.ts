        ...
        fields: [
            {
                ...
                type: "text",
                hint: "Leave blank to let itzg generate its own MOTD.",
                serverPropertiesMapped: true,
                omitIfEmpty: true,
            },
            {key: "MAX_PLAYERS", label: "Max Players", type: "number", serverPropertiesMapped: true},
            {
                ...
                label: "Online Mode",
                type: "toggle",
                hint: "Disabling bypasses Mojang authentication.",
                serverPropertiesMapped: true,
            },
            {key: "ENABLE_WHITELIST", label: "Enable Whitelist", type: "toggle", serverPropertiesMapped: true},
            {
                ...
                type: "tag-input",
                hint: "Comma-separated usernames or UUIDs.",
                serverPropertiesMapped: true,
                omitIfEmpty: true,
            },
            {
    ...
    },
    {
        ...
        fields: [
            ...
            },
            {
                ...
                type: "text",
                hint: "Downloaded and scaled by itzg on start.",
                serverPropertiesMapped: true,
                omitIfEmpty: true,
            },
        ...
        fields: [
            {
                ...
                label: "MeowIce JVM Flags",
                type: "toggle",
                hint: "Default. Aikar's flags updated for Java 21+. Mutually exclusive with Aikar's flags.",
                serverPropertiesMapped: false,
            },
            {
                key: "USE_AIKAR_FLAGS",
                label: "Aikar's GC Flags",
                type: "toggle",
                hint: "Mutually exclusive with MeowIce flags.",
                serverPropertiesMapped: false,
            },
            {
                key: "JVM_OPTS",
                ...
                type: "text",
                hint: "Space-delimited raw JVM flags.",
                serverPropertiesMapped: false,
                omitIfEmpty: true,
            },
            {
                key: "JVM_XX_OPTS",
                label: "Extra JVM -XX Arguments",
                type: "text",
                hint: "Space-delimited -XX options only.",
                serverPropertiesMapped: false,
                omitIfEmpty: true,
            },
        ],
