            ...
            <div className="bg-surface border border-border rounded-lg p-6 w-[420px] space-y-4">
                ...
                <div className="space-y-3">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="w-full bg-surface-high border border-border rounded px-3 py-2 text-xs font-mono text-text-primary focus:border-accent/50 focus:outline-none"
                        />
                        {backendName && !valid && (
                ...
                <div className="flex justify-end gap-2 pt-1">
                    ...
                    <button
                        ...
                        className="px-3 py-1.5 rounded text-xs font-heading font-bold uppercase tracking-widest bg-accent text-bg hover:bg-accent-bright transition-colors disabled:opacity-50"
                    >
                        Add
                    </button>
                </div>
...
export function ProxyBackendsSection({
    ...
    return (
        <div className="border border-border rounded">
            <div className="px-4 py-2.5 border-b border-border bg-surface-high flex items-center justify-between">
                <p className="text-xs font-heading font-bold uppercase tracking-widest text-text-muted">
                    Proxy Backends
                </p>
                <button
                    ...
                    className="flex items-center gap-1.5 px-3 py-1.5 rounded text-xs font-heading font-bold uppercase tracking-widest bg-accent/10 text-accent border border-accent/30 hover:bg-accent/20 transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
                >
            ...
            <div className="px-4 py-3 space-y-4">
                ...
                {!networkId && (
                    <div className="flex items-center justify-between gap-3 text-xs text-warning bg-warning/10 border border-warning/30 rounded px-3 py-2">
                    ...
                    <div className="border border-border rounded overflow-hidden">
                        <table className="w-full text-xs">
                            ...
                            <tr className="border-b border-border bg-surface-high">
                                <th className="px-4 py-2.5 text-left text-xs font-heading font-bold uppercase tracking-widest text-text-muted w-8">
                                    #
                                </th>
                                <th className="px-4 py-2.5 text-left text-xs font-heading font-bold uppercase tracking-widest text-text-muted">
                                    Server
                                </th>
                                <th className="px-4 py-2.5 text-left text-xs font-heading font-bold uppercase tracking-widest text-text-muted">
                                    Backend Name
                                ...
                                >
                                    ...
                                    <td className="px-4 py-3">
                                        <input
                                            ...
                                            className="bg-surface-higher border border-border rounded px-2 py-1 text-xs text-text-primary font-mono w-36 focus:border-accent/50 focus:outline-none"
                                        />
                                    </td>
                                    <td className="px-4 py-3">
                                            <span
