...
Endpoints that require a specific permission are enforced against the caller's effective permissions for the relevant resource. Effective permissions are the union of all global group assignments plus
any assignments scoped to the specific server or network being accessed.
