...
data class ImagesConfig(val minecraftImage: String, val proxyImage: String, val picolimboImage: String = "ghcr.io/quozul/picolimbo") {
    ...
    // PicoLimbo listens on 25565 by default, same as game servers.
