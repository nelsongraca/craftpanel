...
@Serializable
data class AssignmentResponse(val id: String, @SerialName("group_id") val groupId: String, @SerialName("scope_type") val scopeType: ScopeType, @SerialName("scope_id") val scopeId: String?)

@Serializable
data class AssignmentsListResponse(val assignments: List<AssignmentResponse>)

@Serializable
data class CreateAssignmentRequest(@SerialName("group_id") val groupId: String, @SerialName("scope_type") val scopeType: String, @SerialName("scope_id") val scopeId: String? = null)
