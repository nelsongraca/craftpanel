...
class CertificateManagerTest : FunSpec({
    ...
    test("additional SANs appear in server cert") {
        ...
        val san = holder.extensions.getExtensionParsedValue(
            Extension.subjectAlternativeName
        )
            .toString()
        san shouldContain "myhost.local"
        san shouldContain "10.0.0.5"
    }
    ...
    test("server cert always contains localhost and 127.0.0.1") {
        ...
        val san = holder.extensions.getExtensionParsedValue(
            ...
            .toString()
        san shouldContain "localhost"
        san shouldContain "127.0.0.1"
    }
