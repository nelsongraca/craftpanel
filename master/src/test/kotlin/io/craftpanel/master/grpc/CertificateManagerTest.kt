...
class CertificateManagerTest :
    FunSpec({
        ...
        fun manager(additionalSans: List<String> = emptyList()) = CertificateManager(tempDir.absolutePath, additionalSans)

        fun parseCert(pem: String): X509CertificateHolder = PEMParser(StringReader(pem)).readObject() as X509CertificateHolder
